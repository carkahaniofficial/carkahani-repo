...
export default function HomePage() {
  ...
  const heroImages = [
    {
      id: 1,
      src: "/modern-sports-car-on-highway-at-sunset-with-dramat.jpg",
  ...
  const reviewImages = [
    {
      id: 2,
      src: "/2024-porsche-911-turbo-s-silver-sports-car.jpg",
    ...
    {
      id: 3,
      src: "/tesla-model-s-plaid-white-electric-car.jpg",
    ...
    {
      id: 4,
      src: "/bmw-m3-competition-blue-sedan.jpg",
  ...
  const newsImages = [
    ...
    {
      id: 6,
      src: "/hypercar-speed-test-track.jpg",
    ...
    {
      id: 7,
      src: "/autonomous-self-driving-car-technology.jpg",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0 cursor-pointer" onClick={() => handleImageClick(1)}>
          <Image
            src={heroImageError ? "/placeholder.jpg" : "/modern-sports-car-on-highway-at-sunset-with-dramat.jpg"}
            alt="Sports car hero image"
            fill
          ...
          {[
            {
              ...
              image: "/2024-porsche-911-turbo-s-silver-sports-car.jpg",
              imageId: 2,
            },
            {
              title: "Tesla Model S Plaid",
      ...
      {/* Quick Stats */}
      <section className="bg-muted py-12 sm:py-16 lg:py-24 xl:py-32">
        <div className="max-w-7xl xl:max-w-8xl mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 text-center">
            <div className="flex flex-col items-center">
              <div className="bg-primary text-primary-foreground rounded-full p-3 sm:p-4 lg:p-6 xl:p-8 mb-4 lg:mb-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-muted-foreground text-sm sm:text-base lg:text-lg xl:text-xl">{t("carsInDatabase")}</p>
            </div>
          </div>
        </div>
      </section>
